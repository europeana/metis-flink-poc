...
public class DbSource implements Source<ExecutionRecord, DataPartition, DbEnumeratorState> {


    private final ParameterTool parameterTool;

    public DbSource(ParameterTool parameterTool) {
    ...
    public SourceReader<ExecutionRecord, DataPartition> createReader(SourceReaderContext readerContext) throws Exception {
        return new DbReader(readerContext, parameterTool);
    }
